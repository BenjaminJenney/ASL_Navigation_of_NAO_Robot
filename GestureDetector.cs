...
namespace Microsoft.Samples.Kinect.DiscreteGestureBasics
{
    ...
    public class GestureDetector : IDisposable
    {
        ...
        private readonly string gestureDatabase = @"Database\ASLGestures.gbd";

        /// <summary> Name of the discrete gesture in the database that we want to track </summary>
        private readonly string ASLStandGestureName = "ASLStand";
        private readonly string ASLWalkGestureName = "ASLWalk";
        private readonly string ASLTurnLeftGestureName = "ASLTurn_Left";
        private readonly string ASLTurnRightGestureName = "ASLTurn_Right";
        private readonly string ASLStopGestureName = "ASLStop";
        private readonly string ASLSitGestureName = "ASLSit";
